...
> - **MiniMax**: Supports two API types:
>   - **Standard API** (OpenAI-compatible): `"apiBase": "https://api.minimax.io/v1"` (default, uses LiteLLM)
>   - **Coding Plan** (Anthropic-compatible): `"apiBase": "https://api.minimaxi.com/anthropic/v1"` (uses MinimaxProvider)
